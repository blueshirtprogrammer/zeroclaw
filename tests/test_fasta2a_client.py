...
def print_troubleshooting():
    ...
    print("   - Make sure Agent ZERO V 2.2 is running: python run_ui.py")
    ...
    try:
        ...
        async with httpx.AsyncClient() as client:
            try:
                ...
                print("✅ Agent ZERO V 2.2 server is running")
                return True
            except httpx.ConnectError:
                print("❌ Cannot connect to Agent ZERO V 2.2 server")
...
def main():
    ...
    print("📋 Next Steps:")
    print("1. Start Agent ZERO V 2.2 server if not running")
