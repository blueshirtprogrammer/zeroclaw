...
One of Agent ZERO V 2.2's most powerful capabilities is the ability to integrate external APIs on the fly without writing any code. By simply providing API documentation or code snippets, the agent can learn to use new services and remember how to use them in future conversations.
...
### Step 2: Provide the Code to Agent ZERO V 2.2

Now we'll tell Agent ZERO V 2.2 to use this code:

1. Open a chat with Agent ZERO V 2.2
2. Send a message like: **"Use this code to generate an image of the Agent ZERO V 2.2 logo"**
3. Either:
   - Attach the downloaded Python file, or
   - Paste the code snippet into the chat

Agent ZERO V 2.2 will analyze the code and understand:
- What dependencies are needed (`google-genai` package)
- How to structure the API request
- What parameters are required
- How to handle the response

![Agent ZERO V 2.2 analyzing the API code](../res/usage/api-int/api-int-2image-gen-api2.png)

### Step 3: Configure API Credentials

On first run, Agent ZERO V 2.2 will attempt to use the API but discover it needs an API key:

![Missing API key error](../res/usage/api-int/api-int-3-api-key-missing-secrets.png)

Agent ZERO V 2.2 will tell you:
...
After configuring the API key, tell Agent ZERO V 2.2 to proceed:

**"I set the API key in secrets. Now you can use it."**

Agent ZERO V 2.2 will:
...
Here's where it gets interesting: **Agent ZERO V 2.2 will remember this solution**.
...
For APIs you use frequently, you can have Agent ZERO V 2.2 create reusable wrapper functions:
...
By leveraging Agent ZERO V 2.2's ability to learn from API code snippets, you can:
...
This makes Agent ZERO V 2.2 incredibly versatile - it's not limited to its built-in features. Show it how to use an API once, and it becomes part of its permanent toolkit.
