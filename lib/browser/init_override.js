...
//     if (event.data === 'NUVHO_REQUEST_CONTENT') {
...
//           if (event.data?.type === 'NUVHO_FRAME_CONTENT' && 
...
//         iframe.contentWindow.postMessage('NUVHO_REQUEST_CONTENT', '*');
